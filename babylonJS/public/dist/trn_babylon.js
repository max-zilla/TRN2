...
/* harmony import */ var _src_Behaviour_BehaviourManager__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../src/Behaviour/BehaviourManager */ "../src/Behaviour/BehaviourManager.ts");
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var BasicControl = /** @class */ (function (_super) {
    ...
    function BasicControl(nbhv, gameData, objectid, objecttype) {
        var _this = _super.call(this, nbhv, gameData, objectid, objecttype) || this;
        _this.name = BasicControl.name;
        var sceneRender = gameData.sceneRender.object;
        sceneRender.onPointerObservable.add(function (pointerInfo) {
            switch (pointerInfo.type) {
                case babylonjs__WEBPACK_IMPORTED_MODULE_0__["PointerEventTypes"].POINTERDOWN:
                    _this.mousedown(pointerInfo);
                    break;
                case babylonjs__WEBPACK_IMPORTED_MODULE_0__["PointerEventTypes"].POINTERMOVE:
                    _this.mousemove(pointerInfo);
                    break;
            }
        });
        return _this;
    ...
    return BasicControl;
}(_src_Behaviour_BasicControl__WEBPACK_IMPORTED_MODULE_1__["BasicControl"]));

_src_Behaviour_BehaviourManager__WEBPACK_IMPORTED_MODULE_2__["BehaviourManager"].registerFactory(BasicControl);


/***/ }),

/***/ "./src/Behaviour/ParticleSystem.ts":
/*!*****************************************!*\
  !*** ./src/Behaviour/ParticleSystem.ts ***!
  \*****************************************/
...
/* harmony import */ var babylonjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! babylonjs */ "babylonjs");
/* harmony import */ var babylonjs__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(babylonjs__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _src_Proxy_IMesh__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../src/Proxy/IMesh */ "../src/Proxy/IMesh.ts");
/* harmony import */ var _src_Behaviour_Behaviour__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../src/Behaviour/Behaviour */ "../src/Behaviour/Behaviour.ts");
/* harmony import */ var _src_Behaviour_BehaviourManager__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../src/Behaviour/BehaviourManager */ "../src/Behaviour/BehaviourManager.ts");
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var ParticleSystem = /** @class */ (function (_super) {
    ...
    function ParticleSystem(nbhv, gameData, objectid, objecttype) {
        var _this = _super.call(this, nbhv, gameData, objectid, objecttype) || this;
        _this.name = ParticleSystem.name;
        return _this;
    }
    ParticleSystem.prototype.init = function (lstObjs) {
        var _this = this;
        var itemID = this.nbhv.itemid, pname = this.nbhv.name, ofst = __assign({ "x": "0", "y": "0", "z": "0" }, this.nbhv.offset);
        if (lstObjs == null && itemID === undefined) {
            return [_src_Behaviour_Behaviour__WEBPACK_IMPORTED_MODULE_2__["BehaviourRetCode"].dontKeepBehaviour, null];
        }
        var positions = [];
        (lstObjs || []).forEach(function (obj) {
            if (Object(_src_Proxy_IMesh__WEBPACK_IMPORTED_MODULE_1__["isMesh"])(obj)) {
                var q = new (babylonjs__WEBPACK_IMPORTED_MODULE_0__["Quaternion"].bind.apply(babylonjs__WEBPACK_IMPORTED_MODULE_0__["Quaternion"], __spread([void 0], obj.quaternion)))(), v = new babylonjs__WEBPACK_IMPORTED_MODULE_0__["Vector3"](parseInt(ofst.x), parseInt(ofst.y), parseInt(ofst.z));
                var vrot = new babylonjs__WEBPACK_IMPORTED_MODULE_0__["Vector3"]();
                ...
                _this.gameData.objMgr.removeObjectFromScene(obj, true);
            }
        });
        if (itemID !== undefined) {
            itemID = parseInt(itemID);
            for (var i = 0; i < this.gameData.trlvl.trlevel.items.length; ++i) {
                var item = this.gameData.trlvl.trlevel.items[i];
                if (item.objectID == itemID) {
                    positions.push({ "pos": [item.x + parseInt(ofst.x), -item.y + parseInt(ofst.y), -item.z + parseInt(ofst.z)], "obj": null });
                }
            }
        }
        var promise = fetch(this.gameData.relpath + "resources/particle/" + pname + ".json").then(function (response) {
            if (response.ok) {
                response.json().then(function (json) {
                    json = JSON.parse(JSON.stringify(json).replace(/\/resources/g, _this.gameData.relpath + 'resources'));
                    positions.forEach(function (obj, idx) {
                        var psys = babylonjs__WEBPACK_IMPORTED_MODULE_0__["ParticleSystem"].Parse(json, _this.gameData.sceneRender.object, ""), id = _this.objectid ? _this.objectid : parseInt(itemID), pos = obj.pos;
        ...
        return [_src_Behaviour_Behaviour__WEBPACK_IMPORTED_MODULE_2__["BehaviourRetCode"].dontKeepBehaviour, [promise]];
    };
    return ParticleSystem;
}(_src_Behaviour_Behaviour__WEBPACK_IMPORTED_MODULE_2__["Behaviour"]));

_src_Behaviour_BehaviourManager__WEBPACK_IMPORTED_MODULE_3__["BehaviourManager"].registerFactory(ParticleSystem);
...
/* harmony import */ var _Behaviour_BasicControl__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Behaviour/BasicControl */ "./src/Behaviour/BasicControl.ts");
...
/* harmony import */ var _Behaviour_ParticleSystem__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./Behaviour/ParticleSystem */ "./src/Behaviour/ParticleSystem.ts");
/* harmony import */ var _src_Behaviour_Ponytail__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../src/Behaviour/Ponytail */ "../src/Behaviour/Ponytail.ts");
/* harmony import */ var _src_Behaviour_PulsingLight__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../../src/Behaviour/PulsingLight */ "../src/Behaviour/PulsingLight.ts");
/* harmony import */ var _src_Behaviour_RemoveObject__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../../src/Behaviour/RemoveObject */ "../src/Behaviour/RemoveObject.ts");
/* harmony import */ var _src_Behaviour_ScrollTexture__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../../src/Behaviour/ScrollTexture */ "../src/Behaviour/ScrollTexture.ts");
/* harmony import */ var _src_Behaviour_SetAnimation__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../../src/Behaviour/SetAnimation */ "../src/Behaviour/SetAnimation.ts");
/* harmony import */ var _src_Behaviour_Sky__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../../src/Behaviour/Sky */ "../src/Behaviour/Sky.ts");
/* harmony import */ var _src_Behaviour_Skydome__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../../src/Behaviour/Skydome */ "../src/Behaviour/Skydome.ts");
/* harmony import */ var _src_Behaviour_Sprite__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ../../src/Behaviour/Sprite */ "../src/Behaviour/Sprite.ts");
/* harmony import */ var _src_Behaviour_UVRotate__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ../../src/Behaviour/UVRotate */ "../src/Behaviour/UVRotate.ts");
/* harmony import */ var _src_Behaviour_Zbias__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ../../src/Behaviour/Zbias */ "../src/Behaviour/Zbias.ts");
...
var rotY180 = babylonjs__WEBPACK_IMPORTED_MODULE_0__["Quaternion"].RotationAxis(new babylonjs__WEBPACK_IMPORTED_MODULE_0__["Vector3"](0, 1, 0), Math.PI); // x <=> -x
var cstConvert = Math.PI / 180.0;
var Camera = /** @class */ (function () {
    ...
    Camera.prototype.setPosition = function (pos) {
        var _a;
        (_a = this._camera.position).set.apply(_a, __spread(pos));
    };
    Object.defineProperty(Camera.prototype, "quaternion", {
        get: function () {
            var q = this._camera.rotationQuaternion.multiply(rotY180);
    ...
    Camera.prototype.setQuaternion = function (quat) {
        this._camera.rotationQuaternion = new (babylonjs__WEBPACK_IMPORTED_MODULE_0__["Quaternion"].bind.apply(babylonjs__WEBPACK_IMPORTED_MODULE_0__["Quaternion"], __spread([void 0], quat)))().multiply(rotY180);
    ...
    Camera.prototype.lookAt = function (pos) {
        this._camera.setTarget(new (babylonjs__WEBPACK_IMPORTED_MODULE_0__["Vector3"].bind.apply(babylonjs__WEBPACK_IMPORTED_MODULE_0__["Vector3"], __spread([void 0], pos)))());
    };
    return Camera;
}());
...
var Material = /** @class */ (function () {
    ...
    Object.defineProperty(Material.prototype, "transparent", {
        ...
        set: function (t) {
            ...
            this._material.alphaMode = babylonjs__WEBPACK_IMPORTED_MODULE_0__["Engine"].ALPHA_SCREENMODE;
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(Material.prototype, "vertexShader", {
        get: function () {
            ...
            return mat._shaderPath.vertex; //! todo better
        },
        set: function (vs) {
            var mat = this._material;
            mat.options.defines = ["#define __ " + _src_Proxy_Engine__WEBPACK_IMPORTED_MODULE_1__["default"].getShaderMgr().globalLightsInFragment];
            mat._shaderPath.vertex = vs; //! todo better
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(Material.prototype, "fragmentShader", {
        get: function () {
            var mat = this._material;
            return mat._shaderPath.fragment; //! todo better
        },
        set: function (fs) {
            var mat = this._material;
            mat.options.defines = ["#define __ " + _src_Proxy_Engine__WEBPACK_IMPORTED_MODULE_1__["default"].getShaderMgr().globalLightsInFragment];
            mat._shaderPath.fragment = fs; //! todo better
        },
        enumerable: true,
        configurable: true
    });
    Material.prototype.uniformsUpdated = function (names) {
        if (names !== undefined) {
            for (var i = 0; i < names.length; ++i) {
                var uval = this.uniforms[names[i]];
                if (uval) {
            ...
            for (var uname in this.uniforms) {
                var uval = this.uniforms[uname];
                this._setUniformValue(uname, uval);
            }
        }
    };
    Material.prototype._setUniformValue = function (uname, uval) {
        switch (uval.type) {
            case 't':
            ...
            case 'f3':
                if (!uval._value) {
                    uval._value = new babylonjs__WEBPACK_IMPORTED_MODULE_0__["Vector3"](0, 0, 0);
                }
            ...
            case 'f4':
                if (!uval._value) {
                    uval._value = new babylonjs__WEBPACK_IMPORTED_MODULE_0__["Vector4"](0, 0, 0, 0);
                }
            ...
            case 'fv':
                ...
                break;
            case 'm4v':
                this._material.setMatrices(uname, uval.value); //! todo better
                break;
        }
    };
    Material.prototype.clone = function () {
        var shd = this._material.clone(this._material.name + '_copy' + (Material.count++));
        shd._shaderPath = Object.assign({}, shd._shaderPath); //! todo better
    ...
    Material.prototype.cloneUniforms = function (src) {
        var dst = {};
        for (var u in src) {
            dst[u] = {};
            for (var p in src[u]) {
...
var Mesh = /** @class */ (function () {
    function Mesh(obj) {
        ...
        this._materials = [];
        this._visible = true;
        if (obj.material instanceof babylonjs__WEBPACK_IMPORTED_MODULE_0__["MultiMaterial"]) {
            for (var m = 0; m < obj.material.subMaterials.length; ++m) {
                this._materials.push(new _Material__WEBPACK_IMPORTED_MODULE_2__["default"](obj.material.subMaterials[m]));
            }
        }
    }
    Object.defineProperty(Mesh.prototype, "object", {
        get: function () {
            return this._mesh;
        },
        enumerable: true,
    ...
    Object.defineProperty(Mesh.prototype, "materials", {
        ...
        set: function (mat) {
            this._materials = mat;
            var objmat = this._mesh.material = new babylonjs__WEBPACK_IMPORTED_MODULE_0__["MultiMaterial"](this._mesh.name, this._mesh.getScene());
            objmat.subMaterials = [];
            mat.forEach(function (m) { return objmat.subMaterials.push(m.material); });
        },
        enumerable: true,
        configurable: true
    });
    ...
    Mesh.prototype.setPosition = function (pos) {
        var _a;
        (_a = this._mesh.position).set.apply(_a, __spread(pos));
    };
    Object.defineProperty(Mesh.prototype, "quaternion", {
        get: function () {
    ...
    Mesh.prototype.setQuaternion = function (quat) {
        var _a;
        //this.obj.rotationQuaternion = new BQuaternion(...quat).multiply(rotY180);
        (_a = this._mesh.rotationQuaternion).set.apply(_a, __spread(quat));
    };
    Object.defineProperty(Mesh.prototype, "matrixAutoUpdate", {
        get: function () {
            return true;
        },
        set: function (b) {
    ...
    Object.defineProperty(Mesh.prototype, "renderOrder", {
        get: function () {
    ...
    Object.defineProperty(Mesh.prototype, "frustumCulled", {
        get: function () {
    ...
    Mesh.prototype.containsPoint = function (pos) {
        return this._mesh.getBoundingInfo().boundingBox.intersectsPoint(new babylonjs__WEBPACK_IMPORTED_MODULE_0__["Vector3"](pos[0], pos[1], pos[2]));
    };
    Mesh.prototype.showBoundingBox = function (show) {
        this._mesh.showBoundingBox = show;
    };
    Mesh.prototype.clone = function () {
        return new Mesh(this._mesh.clone(this._mesh.name, null));
    };
    Mesh.prototype.setBoundingBox = function (box) {
        var boundingInfo = new babylonjs__WEBPACK_IMPORTED_MODULE_0__["BoundingInfo"](new babylonjs__WEBPACK_IMPORTED_MODULE_0__["Vector3"](box.min[0], box.min[1], box.min[2]), new babylonjs__WEBPACK_IMPORTED_MODULE_0__["Vector3"](box.max[0], box.max[1], box.max[2]), this._mesh.getWorldMatrix());
        this._mesh.setBoundingInfo(boundingInfo);
    };
    Mesh.prototype.getBoundingBox = function () {
        var boundingInfo = this._mesh.getBoundingInfo(), boundingBox = boundingInfo.boundingBox;
        return new _src_Utils_Box3__WEBPACK_IMPORTED_MODULE_1__["Box3"]([boundingBox.minimum.x, boundingBox.minimum.y, boundingBox.minimum.z], [boundingInfo.maximum.x, boundingInfo.maximum.y, boundingInfo.maximum.z]);
    };
    return Mesh;
}());
...
var MeshBuilder = /** @class */ (function () {
    ...
    Object.defineProperty(MeshBuilder.prototype, "vertices", {
        get: function () {
            var geometry = this._mesh.geometry, vertices = geometry.getVerticesData("position", false, false);
            return Array.isArray(vertices) ? vertices : Array.from(vertices);
        },
        enumerable: true,
        configurable: true
    });
    MeshBuilder.prototype.setIndex = function (index, dontUpdateSubMeshes) {
        var geometry = this._mesh.geometry;
        var subMeshes = this._mesh.subMeshes.slice();
        ...
        if (!dontUpdateSubMeshes) {
            ...
            var subm = this._mesh.subMeshes[0];
            subm.indexStart = 0;
            subm.indexCount = index.length;
            for (var m = 1; m < this._mesh.subMeshes.length; ++m) {
    ...
    MeshBuilder.prototype.makeSkinIndicesList = function () {
        ...
        var geometry = this._mesh.geometry, vbSkinIndex = geometry.getVertexBuffer("skinIndex");
        if (!vbSkinIndex) {
            return;
        }
        var index = geometry.getIndices(false), arSkinIndex = this.getArrayFromDataArray(vbSkinIndex);
        for (var i = 0; i < index.length / 3; ++i) {
            var skinIndex = arSkinIndex[index[i * 3 + 0] * 4 + 0];
    ...
    MeshBuilder.prototype.createFaces = function (faces, matIndex) {
        var geometry = this._mesh.geometry, index = Array.from(geometry.getIndices(false)), positions = this.getArrayFromDataArray(geometry.getVertexBuffer("position")), colors = this.getArrayFromDataArray(geometry.getVertexBuffer("vertColor")), normals = this.getArrayFromDataArray(geometry.getVertexBuffer("normal")), uvs = this.getArrayFromDataArray(geometry.getVertexBuffer("uv")), _flags = this.getArrayFromDataArray(geometry.getVertexBuffer("_flags"));
        ...
        index.splice.apply(index, __spread([this._mesh.subMeshes[matIndex].indexStart, 0], addIndex));
        var subMeshes = this._mesh.subMeshes.slice();
        subMeshes[matIndex].indexCount += addIndex.length;
        for (var g = matIndex + 1; g < subMeshes.length; ++g) {
        ...
        for (var submeshIndex = 0; submeshIndex < subMeshes.length; submeshIndex++) {
            var previousOne = subMeshes[submeshIndex];
            babylonjs__WEBPACK_IMPORTED_MODULE_0__["SubMesh"].AddToMesh(previousOne.materialIndex, previousOne.indexStart, previousOne.indexCount, previousOne.indexStart, previousOne.indexCount, this._mesh);
        }
    };
    ...
    MeshBuilder.prototype.removeFaces = function (remove) {
        var geom = this._mesh.geometry, indices = [], index = Array.from(geom.getIndices(false));
        var ofstGroups = this._mesh.subMeshes.map(function () { return 0; });
        for (var i = 0; i < index.length / 3; ++i) {
            if (!remove.has(i)) {
                indices.push(index[i * 3 + 0], index[i * 3 + 1], index[i * 3 + 2]);
            }
            else {
                for (var g = 0; g < this._mesh.subMeshes.length; ++g) {
                    var group = this._mesh.subMeshes[g];
        ...
        for (var g = 0, sum = 0; g < this._mesh.subMeshes.length; ++g) {
    ...
    MeshBuilder.prototype.replaceSkinIndices = function (remap) {
        ...
        var skinIndices = this.getArrayFromDataArray(vbSkinIndex), indices = [];
    ...
    MeshBuilder.prototype.copyFacesWithSkinIndex = function (skinidx, newskinidx) {
        var geometry = this._mesh.geometry, index = Array.from(geometry.getIndices(false)), positions = this.getArrayFromDataArray(geometry.getVertexBuffer("position")), normals = this.getArrayFromDataArray(geometry.getVertexBuffer("normal")), skinIndices = this.getArrayFromDataArray(geometry.getVertexBuffer("skinIndex")), skinWeights = this.getArrayFromDataArray(geometry.getVertexBuffer("skinWeight")), uvs = this.getArrayFromDataArray(geometry.getVertexBuffer("uv")), _flags = this.getArrayFromDataArray(geometry.getVertexBuffer("_flags"));
        var addIndex = [];
        for (var i = 0; i < index.length / 3; ++i) {
    ...
    MeshBuilder.prototype.getArrayFromDataArray = function (vb) {
        var da = vb.getData(), ar = [];
        if (Array.isArray(da)) {
            ar = da;
        }
        else {
            ar = Array.from(new Float32Array(da));
        }
        return ar;
    };
    MeshBuilder.prototype.createMesh = function (name, scene, vshader, fshader, uniforms, vertices, indices, uvs, colors) {
        var activeScene = scene.object;
        var geom = new babylonjs__WEBPACK_IMPORTED_MODULE_0__["Geometry"]("Geometry of " + name, activeScene), attributes = ['position'];
        ...
        var uniformsUsed = new Set();
        _src_Proxy_Engine__WEBPACK_IMPORTED_MODULE_1__["default"].getShaderMgr().getVertexUniforms(vshader).forEach(function (u) { return uniformsUsed.add(u); });
        _src_Proxy_Engine__WEBPACK_IMPORTED_MODULE_1__["default"].getShaderMgr().getFragmentUniforms(fshader).forEach(function (u) { return uniformsUsed.add(u); });
        var samplers = ["map", "mapBump"];
        if (uniforms) {
            for (var uname in uniforms) {
                uniformsUsed.add(uname);
            }
        }
        var shd = new babylonjs__WEBPACK_IMPORTED_MODULE_0__["ShaderMaterial"]("Shader of " + name, activeScene, {
            "vertex": vshader,
            "fragment": fshader,
        }, {
        ...
        var multimat = new babylonjs__WEBPACK_IMPORTED_MODULE_0__["MultiMaterial"]("Material of " + name, activeScene);
        multimat.subMaterials.push(shd);
        this._mesh = new babylonjs__WEBPACK_IMPORTED_MODULE_0__["Mesh"](name, activeScene);
        this._mesh.subMeshes = [];
        this._mesh.material = multimat;
        geom.applyToMesh(this._mesh);
        var tmesh = new _Mesh__WEBPACK_IMPORTED_MODULE_2__["default"](this._mesh), materials = tmesh.materials;
        materials.forEach(function (m) { return m.uniformsUpdated(); });
        scene.add(tmesh);
        return tmesh;
    };
    MeshBuilder.prototype.getIndexAndGroupState = function () {
        var geom = this._mesh.geometry, index = Array.from(geom.getIndices(false));
        var groups = [];
        for (var g = 0; g < this._mesh.subMeshes.length; ++g) {
            groups.push({
...
var Node = /** @class */ (function () {
    function Node(obj, name, scene) {
        this._node = obj ? obj : new babylonjs__WEBPACK_IMPORTED_MODULE_0__["TransformNode"](name ? name : "unnamed Node", scene ? scene.object : null);
        this._children = [];
        this._node.rotationQuaternion = new babylonjs__WEBPACK_IMPORTED_MODULE_0__["Quaternion"]();
    }
    ...
    Node.prototype.setPosition = function (pos) {
        var _a;
        (_a = this._node.position).set.apply(_a, __spread(pos));
    };
    ...
    Node.prototype.setQuaternion = function (quat) {
        var _a;
        (_a = this._node.rotationQuaternion).set.apply(_a, __spread(quat));
    };
    ...
    Node.prototype.decomposeMatrixWorld = function (pos, quat) {
        var _pos = new babylonjs__WEBPACK_IMPORTED_MODULE_0__["Vector3"](), _quat = new babylonjs__WEBPACK_IMPORTED_MODULE_0__["Quaternion"](), _scale = new babylonjs__WEBPACK_IMPORTED_MODULE_0__["Vector3"]();
...
var Renderer = /** @class */ (function () {
    function Renderer(container, engine, canvas) {
        container.appendChild(canvas);
        this._engine = engine;
        var ei = new babylonjs__WEBPACK_IMPORTED_MODULE_0__["EngineInstrumentation"](this._engine);
        ei.captureShaderCompilationTime = true;
        this._sctc = ei.shaderCompilationTimeCounter;
    }
    Object.defineProperty(Renderer.prototype, "engine", {
        get: function () {
            return this._engine;
        },
        enumerable: true,
    ...
    Renderer.prototype.setSize = function (width, height) {
        var scale = this._engine.getHardwareScalingLevel();
        this._engine.setSize(width / scale, height / scale);
    };
    Renderer.prototype.createScene = function () {
        var newScene = new babylonjs__WEBPACK_IMPORTED_MODULE_0__["Scene"](this._engine);
        newScene.useRightHandedSystem = true;
        //newScene.autoClear = false;
        newScene.clearColor = new babylonjs__WEBPACK_IMPORTED_MODULE_0__["Color4"](0, 0, 0, 1);
        newScene.detachControl();
        return new _Scene__WEBPACK_IMPORTED_MODULE_1__["default"](newScene);
    };
    ...
    Renderer.prototype.getPerfData = function (scenes) {
        var numDrawCalls = 0, numObjects = 0, numGeometries = 0, numFaces = 0, numTextures = 0, numParticles = 0, numPrograms = 0;
        ...
        numDrawCalls = new babylonjs__WEBPACK_IMPORTED_MODULE_0__["SceneInstrumentation"](scenes[0].object).drawCallsCounter.current;
...
var Scene = /** @class */ (function () {
    function Scene(scene, textures) {
        ...
        this._scene.clearColor = new babylonjs__WEBPACK_IMPORTED_MODULE_0__["Color4"](0, 0, 0, 1);
        this._camera = null;
    }
    Object.defineProperty(Scene.prototype, "totalNumObjects", {
        get: function () {
    ...
    Scene.prototype.remove = function (obj) {
        var index = this._children.indexOf(obj);
        if (index !== -1) {
            this._children.splice(index, 1);
        }
...
var SceneParser = /** @class */ (function () {
    function SceneParser(engine, shdMgr) {
        this._numMeshesToHandle = 0;
        this.engine = engine;
        this.shdMgr = shdMgr;
        this.scene = new babylonjs__WEBPACK_IMPORTED_MODULE_0__["Scene"](engine);
        this.scene.useRightHandedSystem = true;
        this.scene.autoClear = false;
        this.textures = [];
        this.tscene = new _Scene__WEBPACK_IMPORTED_MODULE_3__["default"](this.scene, this.textures);
        this.textureMap = {};
    ...
    SceneParser.prototype.parse = function (json, onLoad) {
        ...
        var idTimer = setInterval(function () {
            if (_this._numTextureLoadedNotifications == 0 && _this._numMeshesToHandle == 0) {
    ...
    SceneParser.prototype.createScene = function () {
        this.createTextures();
        var objects = this.json.object.children;
    ...
    SceneParser.prototype.createCamera = function (json) {
        ...
        camera.mode = babylonjs__WEBPACK_IMPORTED_MODULE_0__["Camera"].PERSPECTIVE_CAMERA;
        camera.inputs.clear();
        camera.inputs.removeMouse();
        this.scene.setActiveCameraByName(json.name);
        this.tscene.setCamera(new _Camera__WEBPACK_IMPORTED_MODULE_1__["default"](camera));
    ...
    SceneParser.prototype.createMesh = function (json) {
        var _this = this;
        var mesh = new babylonjs__WEBPACK_IMPORTED_MODULE_0__["Mesh"](json.name, this.tscene.object), geometry = this.getGeometry(json.geometry), attr = geometry.data.attributes, groups = geometry.data.groups, materials = json.material;
        mesh.position.set(json.position[0], json.position[1], json.position[2]);
        mesh.rotationQuaternion = new babylonjs__WEBPACK_IMPORTED_MODULE_0__["Quaternion"](json.quaternion[0], json.quaternion[1], json.quaternion[2], json.quaternion[3]);
        mesh.useVertexColors = false;
        mesh.showBoundingBox = false;
        var vDat = new babylonjs__WEBPACK_IMPORTED_MODULE_0__["VertexData"]();
        ...
        for (var i = 0; i < vDat.indices.length; i += 3) {
            var i0 = vDat.indices[i];
            vDat.indices[i] = vDat.indices[i + 2];
            vDat.indices[i + 2] = i0;
        }
        vDat.applyToMesh(mesh);
        mesh.subMeshes = [];
        var attributes = ["position", "uv", "normal"];
        ['vertColor', '_flags', 'skinIndex', 'skinWeight'].forEach(function (attrName) {
            if (attr[attrName]) {
                var buffer = new babylonjs__WEBPACK_IMPORTED_MODULE_0__["Buffer"](_this.engine, Array.from(attr[attrName].array), false, attr[attrName].itemSize);
                mesh.setVerticesBuffer(buffer.createVertexBuffer(attrName, 0, attr[attrName].itemSize));
                attributes.push(attrName);
            }
        });
        var multimat = new babylonjs__WEBPACK_IMPORTED_MODULE_0__["MultiMaterial"](json.name, this.scene), totalVertices = mesh.getTotalVertices(), promises = [];
        var _loop_1 = function (m) {
            var material = this_1.getMaterial(materials[m]);
            var doShaderMat = (function (mat) {
                var material = mat;
                return function (shdCode) {
                    var uniformsUsed = new Set();
                    _this.shdMgr.getVertexUniforms(material.vertexShader).forEach(function (u) { return uniformsUsed.add(u); });
                    _this.shdMgr.getFragmentUniforms(material.fragmentShader).forEach(function (u) { return uniformsUsed.add(u); });
                    var uniforms = Array.from(uniformsUsed);
                    var samplers = ["map", "mapBump"];
                    for (var uname in material.uniforms) {
                        uniforms.push(uname);
                    }
                    var shd = new babylonjs__WEBPACK_IMPORTED_MODULE_0__["ShaderMaterial"](material.uuid, _this.scene, {
                        "vertex": shdCode[0],
                        "fragment": shdCode[1],
                    }, {
                        attributes: attributes,
                    ...
                    var _loop_2 = function (uname) {
                        var uval = material.uniforms[uname];
                        switch (uval.type) {
                            case 't':
                                shd.setTexture(uname, _this.textureMap[uval.value]);
                                if (!_this.textureMap[uval.value].isReady()) {
                                    _this._numTextureLoadedNotifications++;
                                    _this.textureMap[uval.value].onLoadObservable.add(function (texture) {
                                    ...
                                    uval.width = _this.textureMap[uval.value].getSize().width;
                                    uval.height = _this.textureMap[uval.value].getSize().height;
                                }
                                uval.value = _this.textureMap[uval.value];
                                break;
                            case 'i':
                            ...
                            case 'f':
                                ...
                                break;
                            case 'f3':
                                shd.setVector3(uname, new babylonjs__WEBPACK_IMPORTED_MODULE_0__["Vector3"](uval.value[0], uval.value[1], uval.value[2]));
                                break;
                            case 'f4':
                                shd.setVector4(uname, new babylonjs__WEBPACK_IMPORTED_MODULE_0__["Vector4"](uval.value[0], uval.value[1], uval.value[2], uval.value[3]));
                                break;
                        }
                    };
                    for (var uname in material.uniforms) {
                    ...
                    if (material.transparent) {
                        shd.alphaMode = babylonjs__WEBPACK_IMPORTED_MODULE_0__["Engine"].ALPHA_SCREENMODE;
                        shd.disableDepthWrite = true;
                    }
                    multimat.subMaterials.push(shd);
                    babylonjs__WEBPACK_IMPORTED_MODULE_0__["SubMesh"].AddToMesh(multimat.subMaterials.length - 1, 0, totalVertices, groups[m].start, groups[m].count, mesh);
                };
            })(material);
            promises.push(Promise.all([this_1.shdMgr.getVertexShader(material.vertexShader), this_1.shdMgr.getFragmentShader(material.fragmentShader)]).then(function (shdCode) { return doShaderMat(shdCode); }));
        };
        var this_1 = this;
        for (var m = 0; m < materials.length; ++m) {
            _loop_1(m);
        ...
        Promise.all(promises).then(function () {
            ...
            _this.tscene.add(new _Mesh__WEBPACK_IMPORTED_MODULE_2__["default"](mesh));
            _this._numMeshesToHandle--;
        });
    };
    SceneParser.prototype.getImage = function (id) {
        for (var i = 0; i < this.json.images.length; ++i) {
            var image = this.json.images[i];
            if (image.uuid == id) {
                return image;
            }
        }
    };
    SceneParser.prototype.getGeometry = function (id) {
        for (var g = 0; g < this.json.geometries.length; ++g) {
            var geometry = this.json.geometries[g];
            if (geometry.uuid == id) {
                return geometry;
            }
        }
    };
    SceneParser.prototype.getMaterial = function (id) {
        for (var g = 0; g < this.json.materials.length; ++g) {
            var material = this.json.materials[g];
            if (material.uuid == id) {
                return material;
            }
        }
...
var tokenSource = ["modelMatrix", "modelViewMatrix", "projectionMatrix", "viewMatrix", "normalMatrix", "cameraPosition"], tokenDest = ["world", "worldView", "projection", "view", null, null];
var Shader = /** @class */ (function () {
    function Shader() {
    }
    Shader.getShader = function (shaderType, name, code, uniformsUsed) {
        code = Shader.parseShader(code, uniformsUsed);
        babylonjs__WEBPACK_IMPORTED_MODULE_0__["Effect"].ShadersStore["" + name + shaderType + "Shader"] = code;
        return name;
    };
    Shader.parseShader = function (code, uniformsUsed) {
        var tokenizer = new Tokenizer(code), newcode = "";
        while (!tokenizer.isEnd() && tokenizer.getNextToken()) {
            var tokenType = tokenizer.currentToken;
            if (tokenType !== ETokenType.IDENTIFIER) {
                newcode += tokenizer.currentString;
                continue;
            }
            var _a = __read(Shader.parseShaderTokens(tokenizer), 2), token = _a[0], remapped = _a[1];
            if (token == null) {
                console.log(code);
    ...
    Shader.parseShaderTokens = function (tokenizer) {
        for (var i = 0; i < tokenSource.length; ++i) {
            var tokenSrc = tokenSource[i];
...
/*!******************************!*\
  !*** ./src/ShaderManager.ts ***!
  \******************************/
/*! exports provided: ShaderManager */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ShaderManager", function() { return ShaderManager; });
/* harmony import */ var _src_ShaderManager__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../src/ShaderManager */ "../src/ShaderManager.ts");
...
var ShaderManager = /** @class */ (function (_super) {
    __extends(ShaderManager, _super);
    function ShaderManager(dirPath) {
        var _this = _super.call(this, dirPath) || this;
        _this._uniforms = new Map();
        return _this;
    }
    ShaderManager.prototype.getShader = function (ptype, name, forceReload) {
        if (forceReload === void 0) { forceReload = false; }
    ...
    ShaderManager.prototype.getVertexShader = function (name, forceReload) {
        if (forceReload === void 0) { forceReload = false; }
        return this.getShader(_src_ShaderManager__WEBPACK_IMPORTED_MODULE_0__["shaderType"].vertex, name, forceReload);
    };
    ShaderManager.prototype.getFragmentShader = function (name, forceReload) {
        if (forceReload === void 0) { forceReload = false; }
        return this.getShader(_src_ShaderManager__WEBPACK_IMPORTED_MODULE_0__["shaderType"].fragment, name, forceReload);
    };
    ShaderManager.prototype.getUniforms = function (name) {
        return this._uniforms.get(name);
    };
    ShaderManager.prototype.getVertexUniforms = function (name) {
        return this.getUniforms(name + '.vs');
    };
    ShaderManager.prototype.getFragmentUniforms = function (name) {
        return this.getUniforms(name + '.fs');
    };
    ShaderManager.prototype._getFile2 = function (fname, ptype, forceReload) {
        var _this = this;
        if (forceReload === void 0) { forceReload = false; }
        var promiseCode = this._getFile(fname + (ptype == _src_ShaderManager__WEBPACK_IMPORTED_MODULE_0__["shaderType"].vertex ? '.vs' : '.fs'), forceReload);
        return promiseCode.then(function (code) {
            if (code === "") {
                throw "Can't load shader \"" + fname + "\"!";
            }
            var uniformsUsed = new Set();
            _this._uniforms.set(fname + (ptype == _src_ShaderManager__WEBPACK_IMPORTED_MODULE_0__["shaderType"].vertex ? '.vs' : '.fs'), uniformsUsed);
            return _Shader__WEBPACK_IMPORTED_MODULE_1__["default"].getShader(ptype == 'vertex' ? 'Vertex' : 'Fragment', fname, code, uniformsUsed);
        });
    };
    return ShaderManager;
}(_src_ShaderManager__WEBPACK_IMPORTED_MODULE_0__["ShaderManager"]));
...
/* harmony import */ var babylonjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! babylonjs */ "babylonjs");
/* harmony import */ var babylonjs__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(babylonjs__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _src_Utils_Browser__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../src/Utils/Browser */ "../src/Utils/Browser.ts");
/* harmony import */ var _src_Proxy_Engine__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../src/Proxy/Engine */ "../src/Proxy/Engine.ts");
/* harmony import */ var _ShaderManager__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./ShaderManager */ "./src/ShaderManager.ts");
/* harmony import */ var _src_Main__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../src/Main */ "../src/Main.ts");
/* harmony import */ var _Behaviours__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./Behaviours */ "./src/Behaviours.ts");
/* harmony import */ var _MeshBuilder__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./MeshBuilder */ "./src/MeshBuilder.ts");
...
/* harmony import */ var _SceneParser__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./SceneParser */ "./src/SceneParser.ts");
...
var relPath = _src_Utils_Browser__WEBPACK_IMPORTED_MODULE_1__["default"].QueryString.relpath || "";
glMatrix.glMatrix.setMatrixArrayType(Array);
var canvas = document.createElement("canvas"), engine = new babylonjs__WEBPACK_IMPORTED_MODULE_0__["Engine"](canvas, true), shdMgr = new _ShaderManager__WEBPACK_IMPORTED_MODULE_3__["ShaderManager"](relPath + "resources/shader/");
_src_Proxy_Engine__WEBPACK_IMPORTED_MODULE_2__["default"].registerFunctions({
    "makeNode": function (name, scene) { return new _Node__WEBPACK_IMPORTED_MODULE_7__["default"](undefined, name, scene); },
    "makeMeshBuilder": function (mesh) { return new _MeshBuilder__WEBPACK_IMPORTED_MODULE_6__["default"](mesh); },
    "parseScene": function (sceneJSON) {
        var sceneParser = new _SceneParser__WEBPACK_IMPORTED_MODULE_9__["default"](engine, shdMgr);
        return new Promise(function (resolve, reject) {
            sceneParser.parse(sceneJSON, resolve);
        });
    },
    "createRenderer": function (container) {
        return new _Renderer__WEBPACK_IMPORTED_MODULE_8__["default"](container, engine, canvas);
    },
    "getShaderMgr": shdMgr,
});
...
/******/ });
//# sourceMappingURL=trn_babylon.js.map