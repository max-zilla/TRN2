...
var descr = {
    part1: [
        ...
        'weatherType', 'uint16',
        'padding',
        function (dataStream, struct) { dataStream.position += 28; return ''; },
        'levelData_uncompSize', 'uint32',
        'levelData_compSize', 'uint32',
        'unused', 'uint32',
        'numRooms', 'uint16',
        ...
        ['', [
                'xela',
                function (dataStream, struct) { dataStream.position += 4; return ''; },
                'roomDataSize', 'uint32',
                'NA', 'uint32',
                'endSDOffset', 'uint32',
                ...
                'layerData', ['', [], 'numLayers'],
                'faces',
                ['', 'uint8', function (struct, dataStream, type) { return (struct.numRectangles) + (struct.numTriangles); }],
                'vertices', ['', [
